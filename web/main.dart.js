...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      if (A.Primitives_getHours(new A.DateTime(Date.now(), false)) > 11 && A.Primitives_getHours(new A.DateTime(Date.now(), false)) < 14) {
        ...
        if (t1 != null)
          J.set$text$x(t1, string$.Congra);
      }
      myEWallet = new A.EWallet(A._setArrayType([], type$.JSArray_Transaction));
      t1 = document;
      balanceElement = t1.querySelector("#output");
      if (balanceElement != null)
        J.set$text$x(balanceElement, "Account Balance: RM" + B.JSInt_methods.toString$0(0));
      t2 = type$.InputElement;
      topUpAmountElement = t2._as(t1.querySelector("#topUpAmount"));
      topUpButton = t1.querySelector("#topUpButton");
      if (topUpButton != null) {
        t3 = J.get$onClick$x(topUpButton);
        t4 = t3.$ti;
        t5 = t4._eval$1("~(1)?")._as(new A.main_closure(topUpAmountElement, myEWallet));
        type$.nullable_void_Function._as(null);
        A._EventStreamSubscription$(t3._target, t3._eventType, t5, false, t4._precomputed1);
      }
      makePaymentElement = t2._as(t1.querySelector("#makePayment"));
      makePaymentButton = t1.querySelector("#makePaymentButton");
      if (makePaymentButton != null) {
        t2 = J.get$onClick$x(makePaymentButton);
        t3 = t2.$ti;
        t4 = t3._eval$1("~(1)?")._as(new A.main_closure0(makePaymentElement, myEWallet));
        type$.nullable_void_Function._as(null);
    ...
    displayBalance(myEWallet) {
      var balanceElement = document.querySelector("#output");
      if (balanceElement != null)
        J.set$text$x(balanceElement, "Account Balance: RM" + B.JSNumber_methods.toString$0(myEWallet.balance));
    },
    main_closure: function main_closure(t0, t1) {
      this.topUpAmountElement = t0;
      this.myEWallet = t1;
    },
    main_closure0: function main_closure0(t0, t1) {
      this.makePaymentElement = t0;
      this.myEWallet = t1;
    },
  ...
  A.EWallet.prototype = {
    ...
    displayTransactions$0() {
      ...
      for (t2 = this.transactions, t3 = t2.length, t4 = type$.TableCellElement, x = 0, _i = 0; _i < t2.length; t2.length === t3 || (0, A.throwConcurrentModificationError)(t2), ++_i) {
        ...
        B.TableCellElement_methods.set$text(balance[x], B.JSNumber_methods.toString$0(t5));
        ...
        B.TableCellElement_methods.set$text(payment[x], B.JSNumber_methods.toString$0(t6));
        ...
        t7 = transaction.date;
        B.TableCellElement_methods.set$text(date[x], t7.toString$0(0));
        ...
        B.TableCellElement_methods.set$text(remainingAmount[x], B.JSNumber_methods.toString$0(t8));
        if (!(x < tableRow.length))
          return A.ioore(tableRow, x);
        table.appendChild(tableRow[x]);
  ...
  A.main_closure.prototype = {
    call$1($event) {
      var amountStr, amount, t1;
      type$.MouseEvent._as($event);
      amountStr = this.topUpAmountElement.value;
      if (amountStr == null)
        return;
      amount = A.Primitives_parseDouble(amountStr);
      if (amount == null)
        return;
      t1 = this.myEWallet;
      t1.topUp$1(amount);
  ...
  A.main_closure0.prototype = {
    call$1($event) {
      ...
      if (A.Primitives_getHours(now) > 11 && A.Primitives_getHours(now) < 14 && amount < t1.balance) {
        A.print(_s50_);
        B.Window_methods.alert$1(window, _s50_);
      } else {
        t2 = t1.balance;
        if (amount > t2) {
          B.Window_methods.alert$1(window, _s18_);
          A.print(_s18_);
        } else {
          t3 = t2 - amount;
          t1.balance = t3;
  ...
  A.main_closure1.prototype = {
    call$1($event) {
      type$.MouseEvent._as($event);
      this.myEWallet.displayTransactions$0();
    },
    $signature: 1
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.Rti, A._FunctionParameters, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A.StreamSubscription, A._Zone, A.DateTime, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider, A.EWallet, A.Transaction]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.FormElement, A.InputElement, A.SelectElement, A.TableCellElement, A.TableRowElement]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      JSArray_TableCellElement: findType("JSArray<TableCellElement>"),
      JSArray_TableRowElement: findType("JSArray<TableRowElement>"),
      JSArray_Transaction: findType("JSArray<Transaction>"),
